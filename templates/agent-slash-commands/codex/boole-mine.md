...
Do not expose private prompts, keys, credentials, or full agent logs. The Codex runtime is only a candidate proof producer; deterministic verifier/canonicalizer/node replay decides acceptance.
