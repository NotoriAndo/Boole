...
| `local-docs/todo/todo-l1-network-master.md` | `041ebbfde81a04a81791201c1214c145619a3d85945b87314e6bee44f85fea72` (updated 2026-08-27k — the gap is three gaps rather than the one that was measured, and the launcher refuses at the earliest of them, so all three are scheduled as one unit against the single allowed production. The byte headroom for the nested tree is stated as an upper bound and the entry limit as unanswered) |
| `local-docs/todo/EXECUTION-ORDER.md` | `babc7f18fb71f0c365b703559694d85d08d32c1038e3c17024e0670cc4489086` (updated 2026-08-27k — the cursor is the serving gap closure at PLANNED / NOT IMPLEMENTED, with the earliest refusal at startup stage 1 rather than the measured stage 7, duplication rather than symlinks settled by the verifier's exact path-set equality, and both one-shot steps still unspent) |
...
| `local-docs/todo/thesis-realization-roadmap.md` | `da47bdf36df592ba029081585baa3618e55cee02ce217c80d80e1dffa5167f17` (updated 2026-08-27k — planning against the part of a contract just measured rather than the whole of it is named as the failure mode, alongside a lock-named digest that turned out not to be the digest of the code doing the work; the ordering to BF.7 and activation is unchanged) |
