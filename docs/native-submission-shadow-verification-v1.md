...
| `local-docs/todo/todo-l1-network-master.md` | `24b6232137b742f638a1987bef1f89a43c3490c771bc466fce6c89880c5fd06c` (updated 2026-08-27m — the entry-count half of the nesting budget is answered as an upper bound rather than left open: the boot root disk's counted entries, doubled because the runtime closure is contained in the boot one, sit at roughly a seventh of the sealed limit. The sentence claiming no entry count was pinned anywhere is corrected by succession, not edited away) |
| `local-docs/todo/EXECUTION-ORDER.md` | `3006506521f993d2a0f393e4789d38f247623df570d9b869ea967658a6bac045` (updated 2026-08-27m — the fourth of the operator's eight steps is answered ahead of assembly and read-only, so both pre-production budgets now carry a bound under their limit; the build-time check still runs, and the two one-shot steps, production and boot, remain unspent) |
...
| `local-docs/todo/thesis-realization-roadmap.md` | `3357a080447229a680bbf7d488036d7653dc34ec5dbd55239cef5f4f6bc740a9` (updated 2026-08-27m — a negative existence claim about the repository has to name where it looked, and over-stating ignorance is the safe direction to be wrong in because it leaves every gate standing; a bound must also keep saying it is a bound, so a comfortable margin cannot quietly retire the check it was measured against) |
