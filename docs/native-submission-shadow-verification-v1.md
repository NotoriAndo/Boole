...
| `local-docs/todo/todo-l1-network-master.md` | `43ec61aa6208f9330b9c0e01413e0d746023ec8fd829976a97af2898f57e1935` (updated 2026-08-27s — the assembled staging tree is measured rather than added up, in a fifth projection that leaves the fourth step's sealed assertions intact: 17674 entries and 1771449867 payload bytes against a sum of 17671, with the builder's own table and an independent on-disk walk agreeing on all eight keys and all three sealed limits satisfied on the figure that includes the launcher) |
| `local-docs/todo/EXECUTION-ORDER.md` | `99c41f71bb04f89d37b220a4d33e8406640fe4454be830e8feae8ff6d55164a7` (updated 2026-08-27s — the re-measurement step 3 was waiting on is done and sealed, so the precondition for image production is met; image production and boot both remain one-shot and unspent, and production opens only after this measurement is merged to main) |
...
| `local-docs/todo/thesis-realization-roadmap.md` | `8148f86077c59d8047b95cafa53d8266984b714b2d7b0b14d67d9efaa90a67d8` (updated 2026-08-27s — two correct numbers do not add to a correct number; the way to add a capability to a sealed record is to project past it rather than edit it; one function used twice beats two functions that agree; and the environment can manufacture a stop condition, which is why the destination is probed before anything is written) |
