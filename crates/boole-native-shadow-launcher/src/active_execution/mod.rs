...
const OPERATOR_DIAGNOSTIC_CATEGORIES: &[&[u8]] = &[
    ...
    b"rustc_link_failed",
    b"cc_alias_permission_denied",
    b"cc_alias_failed",
    b"gcc_link_permission_denied",
    b"gcc_link_failed",
    b"gcc_frontend_permission_denied",
    b"gcc_frontend_failed",
    b"gcc_assembler_permission_denied",
    b"gcc_assembler_failed",
    b"gcc_final_link_permission_denied",
    b"gcc_final_link_failed",
    b"rustc_default_linker_permission_denied",
    b"rustc_explicit_gcc_permission_denied",
    b"rustc_explicit_gcc_failed",
