...
//! the fixed manager cgroup, removing exact startup `run-*` orphan leaves and
//! running the four fixed pre-bind toolchain compatibility probes. It does not
//! bind or accept a socket, issue readiness, spawn a checker, or expose an
