...
//! launcher root/capability prerequisite check, and the input-free pre-lock
//! composition of that proof with installed authority and fixed service
//! identities. It does not bind or accept a socket, spawn a checker, or expose
//! an execution/report API.
