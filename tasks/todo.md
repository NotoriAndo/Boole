...
- [x] D5 candidate inventory documented in `docs/node-runtime-responsibility-inventory.md`; next risk is `local_node.rs` route/domain concentration, not reopening core runtime IO.
