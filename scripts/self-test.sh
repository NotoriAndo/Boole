...
run_logged fresh-answer-canary-protocol cargo test --locked -p boole-native-shadow-protocol --features fresh-answer-canary --lib --test fresh_answer_canary
run_logged fresh-answer-canary-node cargo test --locked -p boole-node --features fresh-answer-canary --lib native_shadow_replay_service::canary
run_logged fresh-answer-canary-clippy cargo clippy --locked -p boole-node -p boole-native-shadow-protocol -p boole-native-shadow-launcher --features boole-node/fresh-answer-canary,boole-native-shadow-protocol/fresh-answer-canary,boole-native-shadow-launcher/fresh-answer-canary --all-targets -- -D warnings
run_logged python-script-tests python3 -m unittest scripts/test_install_script.py scripts/test_ci_workflow_contract.py scripts/test_native_checker_toolchain_installer.py scripts/test_native_shadow_provenance_manifest.py scripts/test_native_shadow_rootfs_acquire.py scripts/test_native_shadow_rootfs_portable_v2.py scripts/test_native_shadow_rootfs_builder.py scripts/test_native_shadow_rootfs_oci_verify.py scripts/test_native_shadow_boot_artifact_builder_arm64_v1.py scripts/test_native_shadow_guest_init_compatibility_arm64_v1.py scripts/test_native_shadow_boot_rootfs_resolver_v2.py scripts/test_native_shadow_boot_rootfs_dependency_candidate_arm64_v1.py scripts/test_native_shadow_boot_rootfs_payload_acquire_arm64_v1.py scripts/test_native_shadow_boot_rootfs_source_lock_arm64_v1.py scripts/test_native_shadow_boot_rootfs_source_lock_plan_arm64_v2.py scripts/test_native_shadow_boot_rootfs_source_lock_arm64_v2.py scripts/test_native_shadow_boot_rootfs_source_lock_sealed_arm64_v2.py scripts/test_native_shadow_boot_rustdist_acquire_arm64_v1.py scripts/test_native_shadow_launcher_build_arm64_v1.py scripts/test_native_shadow_boot_image_builder_authority_arm64_v1.py scripts/test_native_shadow_boot_kernel_extract_arm64_v1.py scripts/test_native_shadow_boot_systemd_closure_arm64_v1.py scripts/test_native_shadow_boot_artifact_plan_arm64_v2.py scripts/test_native_shadow_boot_image_producer_authority_arm64_v2.py scripts/test_native_shadow_boot_initrd_arm64_v1.py scripts/test_native_shadow_boot_root_disk_arm64_v1.py scripts/test_native_shadow_boot_image_verify_arm64_v1.py scripts/test_native_shadow_rootfs_builder_boot_arm64_v1.py scripts/test_native_shadow_rootfs_portable_boot_arm64_v1.py scripts/test_native_shadow_rootfs_builder_boot_arm64_v2.py scripts/test_native_shadow_boot_staging_measure_arm64_v1.py scripts/test_native_shadow_boot_image_produce_arm64_v1.py scripts/test_native_shadow_boot_rootfs_closure_exception_arm64_v1.py scripts/test_native_shadow_boot_launcher_deploy_arm64_v1.py scripts/test_native_shadow_boot_root_disk_execute_arm64_v1.py scripts/test_native_shadow_launcher_emit_arm64_v1.py scripts/test_native_shadow_boot_produce_phase_arm64_v1.py scripts/test_native_shadow_boot_produce_driver_arm64_v1.py scripts/test_native_shadow_boot_root_disk_readback_arm64_v1.py scripts/test_native_shadow_boot_root_disk_tree_diff_arm64_v1.py scripts/test_native_shadow_boot_root_disk_determinism_arm64_v1.py scripts/test_native_shadow_boot_root_disk_determinism_successor_arm64_v1.py scripts/test_native_shadow_boot_root_disk_determinism_fix_arm64_v1.py scripts/test_native_shadow_boot_root_disk_determinism_green_arm64_v1.py scripts/test_native_shadow_mac3_closed_local_boot_qualification_arm64_v1.py scripts/test_native_shadow_mac3_closed_local_boot_qualification_arm64_v2.py scripts/test_native_shadow_mac3_closed_local_boot_qualification_arm64_v3.py scripts/test_native_shadow_mac3_closed_local_boot_execution_contract_arm64_v3.py scripts/test_native_shadow_mac3_guest_secret_absence_scan_arm64_v1.py scripts/test_native_shadow_mac3_guest_evidence_protocol_arm64_v1.py scripts/test_native_shadow_mac3_closed_local_boot_rehearsal_arm64_v1.py scripts/test_native_shadow_mac3_closed_local_boot_driver_arm64_v1.py scripts/test_native_shadow_mac3_closed_local_boot_successor_driver_arm64_v2.py scripts/test_native_shadow_mac3_closed_local_boot_result_arm64_v1.py scripts/test_native_shadow_mac3_closed_local_boot_result_arm64_v2.py scripts/test_native_shadow_mac3_guest_runtime_contract_arm64_v1.py scripts/test_native_shadow_mac3_guest_runtime_inputs_arm64_v1.py scripts/test_native_shadow_mac3_successor_image_production_criteria_arm64_v1.py scripts/test_native_shadow_mac3_runtime_serving_gap_measurement_arm64_v1.py scripts/test_native_shadow_mac3_runtime_path_generation_correction_arm64_v1.py scripts/test_native_shadow_mac3_serving_gap_closure_plan_arm64_v1.py scripts/test_native_shadow_mac3_condition_4_correction_arm64_v1.py scripts/test_native_shadow_mac3_nested_runtime_entry_budget_arm64_v1.py scripts/test_native_shadow_mac3_condition_4_descent_refusal_gate_arm64_v1.py scripts/test_native_shadow_successor_produce_phase_arm64_v2.py scripts/test_native_shadow_successor_root_disk_readback_arm64_v2.py scripts/test_native_shadow_successor_image_preservation_arm64_v4.py scripts/test_native_shadow_boot_rootfs_runtime_mount_points_arm64_v1.py scripts/test_native_shadow_boot_root_disk_writer_closure_arm64_v1.py scripts/test_native_shadow_boot_writer_tree_arm64_v1.py scripts/test_native_shadow_boot_ci_payload_acquire_arm64_v1.py scripts/test_native_shadow_boot_writer_set_acquire_arm64_v1.py scripts/test_native_shadow_boot_e2fsprogs_candidate_preregistration_arm64_v1.py scripts/test_native_shadow_boot_e2fsprogs_selection_plucky_arm64_v1.py scripts/test_native_shadow_authority.py scripts/test_native_shadow_real_parity.py scripts/test_native_shadow_checker_cargo_diagnostic.py scripts/test_native_shadow_qualified_execution_api.py scripts/test_native_shadow_http_replay_gate.py scripts/test_native_shadow_mcp_real_trace_gate.py scripts/test_native_shadow_crash_restart_gate.py scripts/test_rp0_active_adapter_supply_preflight.py scripts/test_preflight_orchestration.py scripts/test_model_benchmark.py scripts/test_self_test_contract.py scripts/test_workspace_invariants_contract.py scripts/test_supply_chain_contract.py scripts/test_state_dir_contract.py scripts/test_state_dir_runtime_contract.py scripts/test_storage_durability_contract.py scripts/test_nonce_burn_before_block_contract.py scripts/test_verify_answer_payment_gate_contract.py scripts/test_mock_verify_accept_feature_gate_contract.py scripts/test_multi_store_commit_ordering_contract.py scripts/test_reuse_signal_experiment.py
run_logged native-shadow-launcher-v2-contract python3 -m unittest scripts/test_native_shadow_launcher_build_arm64_v2.py scripts/test_native_shadow_launcher_emit_arm64_v2.py scripts/test_native_shadow_mac3_guest_evidence_protocol_arm64_v2.py scripts/test_native_shadow_launcher_v2_image_integration_preregistration_arm64_v1.py scripts/test_native_shadow_rootfs_builder_boot_arm64_v4.py scripts/test_native_shadow_launcher_v2_image_preflight_arm64_v1.py scripts/test_native_shadow_launcher_v2_image_preflight_workflow_arm64_v1.py scripts/test_native_shadow_launcher_v2_image_preflight_result_arm64_v1.py scripts/test_native_shadow_launcher_v2_successor_producer_preregistration_arm64_v1.py scripts/test_native_shadow_launcher_v2_successor_producer_import_closure_correction_arm64_v1.py scripts/test_native_shadow_successor_produce_phase_arm64_v3.py scripts/test_native_shadow_successor_root_disk_readback_arm64_v3.py scripts/test_native_shadow_successor_produce_workflow_arm64_v3.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_result_arm64_v1.py scripts/test_native_shadow_successor_producer_fingerprint_arm64_v5.py scripts/test_native_shadow_launcher_v2_successor_production_generation_preregistration_arm64_v1.py scripts/test_native_shadow_successor_production_dispatch_fence_correction_arm64_v1.py scripts/test_native_shadow_successor_produce_phase_arm64_v4.py scripts/test_native_shadow_successor_produce_workflow_arm64_v4.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_hard_stop_arm64_v2.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_hard_stop_arm64_v3.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_hard_stop_correction_arm64_v1.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_hard_stop_arm64_v4.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_hard_stop_correction_arm64_v2.py
run_logged audit-current-contract-tests python3 -m unittest scripts/test_self_test_prewarm.py scripts/test_boole_miner_smoke_contract.py scripts/test_audit_test_registration.py scripts/test_boole_testkit_contract.py scripts/test_clap_derive_contract.py scripts/test_public_benchmark_artifacts.py scripts/test_secret_redactor_contract.py scripts/test_telemetry_contract.py
run_logged native-shadow-launcher-v2-r2-evidence python3 -m unittest scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_result_arm64_v2.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_artifact_provenance_arm64_v2.py
run_logged native-shadow-successor-producer-f6 python3 scripts/test_native_shadow_successor_producer_fingerprint_arm64_v6.py
run_logged native-shadow-successor-main-branch-dispatch-fence-correction python3 scripts/test_native_shadow_successor_main_branch_dispatch_fence_correction_arm64_v1.py
run_logged native-shadow-successor-v5-contract python3 -m unittest scripts/test_native_shadow_successor_generation_v5_contract.py scripts/test_native_shadow_successor_produce_phase_arm64_v5.py scripts/test_native_shadow_successor_produce_workflow_arm64_v5.py
run_logged native-shadow-closed-local-image-readiness python3 -m unittest scripts/test_native_shadow_closed_local_image_to_readiness_arm64_v1.py scripts/test_native_shadow_closed_local_image_readiness_workflow_arm64_v1.py
run_logged native-shadow-closed-local-mac-readiness python3 -m unittest scripts/test_native_shadow_closed_local_mac_readiness_arm64_v1.py scripts/test_native_shadow_mac3_guest_evidence_protocol_arm64_v2.py
run_logged native-shadow-mac4-authenticated-channel python3 -m unittest scripts/test_native_shadow_mac4_authenticated_channel_v1.py scripts/test_native_shadow_mac4_channel_runner_arm64_v1.py scripts/test_native_shadow_mac4_authenticated_channel_result_v1.py scripts/test_native_shadow_closed_local_image_to_readiness_arm64_v2.py scripts/test_native_shadow_closed_local_image_to_readiness_arm64_v3.py scripts/test_native_shadow_mac4_authenticated_channel_result_v2.py scripts/test_native_shadow_mac4_authenticated_channel_result_v3.py scripts/test_native_shadow_installed_mac_e2e_v1.py scripts/test_native_shadow_installed_mac_e2e_result_v1.py scripts/test_native_shadow_installed_product_lifecycle_result_v1.py scripts/test_native_shadow_installed_mac_crash_restart_e2e_v1.py scripts/test_native_shadow_installed_mac_crash_restart_result_v1.py
run_logged native-shadow-launcher-v2-r3-evidence python3 -m unittest scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_result_arm64_v3.py scripts/test_native_shadow_launcher_v2_successor_producer_rehearsal_artifact_provenance_arm64_v3.py
run_logged native-shadow-successor-producer-f7 python3 -m unittest scripts/test_native_shadow_successor_producer_fingerprint_arm64_v7.py
