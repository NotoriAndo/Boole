...
run_logged native-shadow-mac4-authenticated-channel python3 -m unittest scripts/test_native_shadow_mac4_authenticated_channel_v1.py scripts/test_native_shadow_mac4_channel_runner_arm64_v1.py scripts/test_native_shadow_mac4_authenticated_channel_result_v1.py
