...
run_logged native-shadow-launcher-v2-contract python3 -m unittest scripts/test_native_shadow_launcher_build_arm64_v2.py scripts/test_native_shadow_mac3_guest_evidence_protocol_arm64_v2.py
